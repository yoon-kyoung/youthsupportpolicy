...
![합치는 과정](docs/merge-flow.jpg)

1. **임종권이 PR을 올림** — "합쳐도 될까요?" 요청
2. **팀원분들이 확인** — 링크에서 테스트해보고 괜찮으면 댓글/카톡으로 알려주기
3. **최윤경님이 GitHub에서 "Merge" 버튼 클릭** → main에 합쳐짐
4. **합쳐지면 자동으로** 우리 최종 사이트에 챗봇이 추가됨!
